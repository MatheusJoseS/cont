    ...
    <div className="">
      ...
      <main className="flex justify-between">
        <div className="w-1/2">
          ...
          <a href="/SOSconf"><div style={{ background: '#EC6161', borderRadius: '2rem' }} className="flex justify-between h-24 w-2/3 m-auto mt-16 p-9" tabIndex={5}><img src="/imagens/engrenagem1.png" alt="Imagen do SOS" className="w-24 h-20 ml-2 -mt-8" /> <strong className="mr-28 text-white text-3xl">Configuração do SOS</strong></div></a>
        </div>
