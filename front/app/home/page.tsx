    ...
    <div className="">
      ...
      <main className="flex justify-between">
        <div className="w-1/2 ">
          ...
          <a href="/diarioD" style={{ background: '#D8CADB', borderRadius: '2rem', marginLeft: '10rem' }} className=" h-24 w-2/3 ml-36 mt-16 p-9 flex justify-between" tabIndex={7}><img src="/imagens/livro.png" alt="Imagen do Dicas" className="w-24 h-20 -mt-7" /> <strong className="mr-64 pr-1 text-white text-3xl">Meu Diario</strong></a>
